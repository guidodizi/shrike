...
to execute:
> python pipelines/experiments/demo_component_with_parameter.py
--config-dir pipelines/config
--config-name experiments/demo_component_with_parameter
run.submit=True
"""
...
class ComponentWithParameterDemo(AMLPipelineHelper):
    ...
    def build(self, config):
        ...
        # helper functions below load the subgraph/component
        # from registered or local version depending on
        # your config.run.use_local
        ...
        @dsl.pipeline(
            ...
            description="The demo of a component that operates on a parameter",
    ...
    def pipeline_instance(self, pipeline_function, config):
        ...
        The goal of this function is to map the config to
        the pipeline_function inputs and params.
